...
const FOOT = {
  nl: { auto: 'Dit is een automatisch bericht van honorcareinternational.com', offices: 'Nederland — Torenlaan 5A, 1402 BN Bussum  ·  Polen — Białka 15, 09-550 Szczawin Kościelny', legal: 'Honor Care International verzorgt werving, voorbereiding en begeleiding. De officiële arbeidsbemiddeling en het dienstverband lopen via ons geregistreerde partnerbureau. Voor kandidaten zijn onze diensten kosteloos.', site: 'Website', wa: 'WhatsApp' },
  en: { auto: 'This is an automated message from honorcareinternational.com', offices: 'Netherlands — Torenlaan 5A, 1402 BN Bussum  ·  Poland — Białka 15, 09-550 Szczawin Kościelny', legal: 'Honor Care International provides recruitment, preparation and support. The official placement and employment run through our registered partner agency. Our services are free of charge for candidates.', site: 'Website', wa: 'WhatsApp' },
  es: { auto: 'Este es un mensaje automático de honorcareinternational.com', offices: 'Países Bajos — Torenlaan 5A, 1402 BN Bussum  ·  Polonia — Białka 15, 09-550 Szczawin Kościelny', legal: 'Honor Care International se encarga de la captación, la preparación y el acompañamiento. La intermediación laboral y el empleo se gestionan a través de nuestra agencia asociada registrada. Nuestros servicios son gratuitos para los candidatos.', site: 'Sitio web', wa: 'WhatsApp' },
  pl: { auto: 'To jest wiadomość automatyczna z honorcareinternational.com', offices: 'Holandia — Torenlaan 5A, 1402 BN Bussum  ·  Polska — Białka 15, 09-550 Szczawin Kościelny', legal: 'Honor Care International zajmuje się rekrutacją, przygotowaniem i wsparciem. Oficjalne pośrednictwo pracy i zatrudnienie realizuje nasze zarejestrowane biuro partnerskie. Dla kandydatów nasze usługi są bezpłatne.', site: 'Strona', wa: 'WhatsApp' }
};
