...
const ROUTES = {
  pl: { eyebrow: 'DWIE ŚCIEŻKI', h2: 'Dwie drogi do holenderskiej ochrony zdrowia', sub: 'Kraj pochodzenia wyznacza ścieżkę. Prowadzimy oba procesy — od pierwszej rozmowy do pierwszego dnia pracy.', cards: [
    { cls: 'eu', flag: '🇪🇸', h: 'Hiszpania i UE', badge: 'Najszybsza ścieżka', items: ['Bez wizy i zezwolenia na pracę — swobodny przepływ pracowników w UE', 'Dyplomy m.in. pielęgniarek i lekarzy z UE są uznawane w Holandii', 'Prowadzimy przez rejestrację BIG w CIBG', 'Język niderlandzki (NT2) to najważniejszy krok — szkolimy u nas', 'Szybsze wejście do pracy'], time: 'Czas trwania: zależy przede wszystkim od poziomu językowego.', btn: 'ZOBACZ ŚCIEŻKĘ' },
  ...
  en: { eyebrow: 'TWO ROUTES', h2: 'Two routes into Dutch healthcare', sub: 'The country of origin determines the route. We handle both journeys in full — from the first conversation to the first working day.', cards: [
    { cls: 'eu', flag: '🇪🇸', h: 'Spain & the EU', badge: 'Fastest route', items: ['No visa or work permit — free movement of workers within the EU', 'EU diplomas of nurses, doctors and others are recognised in the Netherlands', 'We guide you through BIG registration with the CIBG', 'Dutch (NT2) is the key step — and we provide that training', 'Ready to start on the ward sooner'], time: 'Timeline: mainly determined by your Dutch language level.', btn: 'SEE THE ROUTE' },
  ...
  es: { eyebrow: 'DOS RUTAS', h2: 'Dos caminos hacia la sanidad neerlandesa', sub: 'El país de origen determina la ruta. Gestionamos ambos procesos por completo, desde la primera conversación hasta el primer día de trabajo.', cards: [
    { cls: 'eu', flag: '🇪🇸', h: 'España y la UE', badge: 'La ruta más rápida', items: ['Sin visado ni permiso de trabajo: libre circulación de trabajadores en la UE', 'Los títulos de la UE de enfermeros, médicos y otros se reconocen en los Países Bajos', 'Te acompañamos en el registro BIG ante el CIBG', 'El neerlandés (NT2) es el paso clave, y esa formación la damos nosotros', 'Incorporación más rápida al puesto'], time: 'Duración: depende sobre todo de tu nivel de neerlandés.', btn: 'VER LA RUTA' },
