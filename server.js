...
app.get('/salaris', (req, res) => {
  ...
  const body = `<section class="page-hero ph-salaris"><div class="page-hero-inner"><h1>${esc(s.title)}</h1></div></section>`
    + renderSalary(lang, { esc, icon }) + footer(lang);
  res.send(layout(s.title, body, 'salaris', lang, req.path));
});
